...
<script>
	function showAlert(storeId, productId) {
		var txt;
	...
	function modifyItem(storeId, productId) {
			...
			<tr style="background-color: #fefef5;">
				...
				<td style="text-align: center; background-color: #EEA43B;"><strong><span
						style="color: #000000;">&nbsp;<a
							href="javascript:modifyItem(<%=item.getStoreId()%>,<%=item.getProductId()%>);"><img
				...
				<td style="text-align: center; background-color: #b90a2d;"><strong><span
						style="color: #000000;">&nbsp;<a
							href="javascript:showAlert(<%=item.getStoreId()%>,<%=item.getProductId()%>);"><img
