...
<body>
	<form action="Modify" name="editForm" method="post" onsubmit="return validateForm()">
		<br> <br>
		<%
		...
		<table style="border: 1px solid #000000;" border="1" align="center">
				...
				<td colspan="2"
					style="text-align: center; background-color: #EFEFEE;"><strong><span
						style="color: #000000;">&nbsp;<input type="text"
							name="productName" value="<%=item.getProductName()%>"></span></strong></td>
			<tr>
			<tr style="background-color: #315FA5;">
				<td style="text-align: center;"><strong><span
				...
				<td colspan="2"
					style="text-align: center; background-color: #EFEFEE;"><strong><span
						style="color: #000000;">&nbsp;<input type="text"
							name="vendor" value="<%=item.getVendor()%>"></span></strong></td>
			</tr>
			<tr style="background-color: #315FA5;">
				<td style="text-align: center;"><strong><span
			...
			<tr style="background-color: #315FA5;">
				...
				<td colspan="2"
					style="text-align: center; background-color: #EFEFEE;"><strong><span
						style="color: #000000;">&nbsp;<input type="text"
							name="batchNumber" value="<%=item.getBatchNum()%>"></span></strong></td>
			</tr>
			<tr style="background-color: #315FA5;">
				<td style="text-align: center;"><strong><span
				...
				<td colspan="2"
					style="text-align: center; background-color: #EFEFEE;"><strong><span
						style="color: #000000;">&nbsp;<input type="date"
							name="batchDate" value="<%=item.getBatchDate()%>"></span></strong></td>
			</tr>
			<tr style="background-color: #315FA5;">
				<td style="text-align: center;"><strong><span
				...
				<td colspan="2"
					style="text-align: center; background-color: #EFEFEE;"><strong><span
						style="color: #000000;">&nbsp;<input type="number" min="0"
							name="quantity" value="<%=item.getQuantity()%>"></span></strong></td>
			</tr>
			<tr style="background-color: #315FA5;">
				<td colspan="3"
